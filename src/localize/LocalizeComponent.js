...
let strings = new LocalizedStrings({
 en:{
   ...
   cancel_small:"cancel",
   creators_business:"Creators&Business",
   business_continue:"business",
   bb_11:"Let the whole world",
   know:"know",
   bb_12:"about your",
   millionN:"million",
   ...
   make5:"You can monitor the progress and analyze the results of the advertising campaign by yourself",
   improve0:"Improve",
   improve1:"the entire process of interaction between businesses and social media users",
   improve2:"Thanks to our professionalism, constant support, an inherent desire to make your business recognizable and allow Influencers and content creators to collaborate effectively and turn their passion for video creation into a business",
   reports:"Get daily, weekly ",
   reports0:"reports",
   reports1:"You have a dashboard with all information what you need, analysis the progress of implemented posts and their success, track progress on map, how many users came to your business from particular influencer and from which country and be connected with them",
 ...
 ru:{
   ...
   description_placeholder:"Опишите текущую задачу для бизнеса и что вы хотите услышать от создателей,создателей видео",
   ...
   step3_5_2:" дней",
   step3_6:"Каждый день в разное время система проверяет размещенное видео в вашей социальной сети",
   ...
   m1_insruction_step9:"Обратите внимание (знайте, что клиент может платить чаевые за дополнительные публикации в других социальных сетях)",
   type_of_post:'Тип',
   type1:'видео пост',
   ...
   minSum:"минимум 1$",
   dialogDefaultText:"AI Echohub.io выберет для вас лучших создателей и распределит ваш бюджет. Вы согласны?",
   dialogDefaultTextCheckbox:"AI Echohub.io выберет для вас лучших создателей и распределит ваш бюджет",
   ...
   increase4:"Делаем  так, чтобы видео о Вашем бизнесе привлекало внимание людей по всему земному шару",
   ...
   giveContent4:"Помогаем активным пользователям социальных сетей монетизировать свои творческие идеи и получать пассивный доход",
   simplify:"Автоматизируеи и",
   simplify1:" упрощаем",
   simplify2:" процесс распространения Вашего видео среди инфлюенсеров и создателей контента",
   simplify3:"Больше никаких поисков и затратных действий для установления контакта и взаимодействия с активными пользователями социальных сетей",
   make0:"Делаем ",
   make1:"управление ",
   make2:"и",
   make3:"отслеживание",
   make4:"эффективности рекламы простым и легким для Вас",
   make5:"Делаем так, чтобы Вы можете самостоятельно контролировать прогресс и анализировать результаты рекламной кампании",
   improve0:"Улучшаем",
   improve1:"весь процесс взаимодействия бизнесов с активными пользователями социальных сетей",
   improve2:"Благодаря нашему профессионализму, постоянной поддержке и безудержным стремлением сделать Ваш бизнес узнаваемым, а инфлюенсерам и создателям контента предоставить возможность эффективно сотрудничать и превратите свою страсть к созданию видео в бизнес",
   reports:"Получайте ежедневные, еженедельные ",
   reports0:"отчеты",
   reports1:"У вас есть панель отслеживания и контроля со всей информацией о состоянии ваших дел, анализируй прогресс постов и их успех, отслеживай прогресс на карте,сколько пользователей пришли к вам от определенных создателей контента и с какой страны , будь соединен с ними",
