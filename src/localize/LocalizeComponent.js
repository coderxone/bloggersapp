...
let strings = new LocalizedStrings({
 ...
 ru:{
   ...
   highRank:"Работать только с известными создательами",
   ...
   gpsInTwo:"Возможность работы с ближайшими создательами по GPS",
   ...
   q4:"Работать только с местными создательами по GPS?",
   q5:"Работать только с известными создательами?(Дороже)",
   ...
   a1:"все создатели нашей системы опубликуют ваше видео",
   ...
   a7:"Автоматизированный процесс поиска создательа для ваших задач.",
   a8:"легкое взаимодействие со всеми создательами через систему. (Сообщения, сообщить об улучшении и т.д).",
   ...
   b_1:"живая запись создательа о вашем бизнесе",
   ...
   b_4:"возможность работы с ближайшими создательами по GPS или сделать заявку доступной для всех создателей.",
   b_5:"Автоматизированный процесс поиска создательа для ваших задач.",
   b_6:"все создатели нашей системы опубликуют ваше видео",
   b_7:"создатель может приехать и сотрудничая с вами создать отличное видео.",
   b_8:"Легкое взаимодействие со всеми создательами через систему. (Сообщения, сообщить об улучшении и т.д)",
   ...
   b_13:"После создания все создатели публикуют ваше видео во все социальные сети.",
   b_14:"увеличение и распространение ваших продаж",
   b_15:"Также бизнес может описать четкие указания того, над чем создательу нужно работать и сосредоточится.",
   ...
   step3_5:"Подождать одобрения системы в течение 7 дней",
