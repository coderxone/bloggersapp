...
export default function BasicTable(props){
  ...
  const url = "https://echohub.io/confirm/" + props.url;
        ...
        <table style={{width:'100%',color:'black',padding:'4px',lineHeight:'26px'}}>
          <thead>
           <tr style={{width:'100%',marginBottom:'15px'}}>
             <th colSpan="2"  style={{textAlign:'center',fontSize:'20px',paddingTop:'5px'}}>{LocalizeComponent.text1} {currentUser} !😊  {LocalizeComponent.text2} "->" <a target="_blank"  href={url}>{LocalizeComponent.text3}</a> </th>
           </tr>
          </thead>
